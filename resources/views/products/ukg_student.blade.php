...
@section('contents')
    ...
    <form id="myForm" action="{{ isset($product) ? route('products.update', $product->id) : route('products.saveukg') }}" method="post"
  ...
  <input id="student_image_upload_ukg" type="file" name="student_image" accept="image/*" style="display: none" onchange="showFile_ukg(event)">
</div>
