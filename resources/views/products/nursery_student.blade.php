...
<form id="myForm"
    action="{{ isset($product) ? route('products.update', $product->id) : route('products.savenursery') }}"
                ...
                <div class="card-body">
                    ...
                    <div class="flex flex-col md:items-start items-center md:justify-start justify-center">
                        ...
                        <div>
                            ...
                            <input id="student_image_upload_nursery" type="file" name="student_image" accept="image/*"
                                style="display: none" onchange="showFile_nursery(event)">
                        </div>
                    </div>
