...
@section('contents')
    ...
    <form id="myForm" action="{{ isset($product) ? route('products.update', $product->id) : route('products.savenursery') }}" method="post"
  ...
  <input id="student_image_upload_nursery" type="file" name="student_image" accept="image/*" style="display: none" onchange="showFile_nursery(event)">
</div>
...
<div class="mt-10 text-black">
  ...
  function showFile_nursery(event) {
    ...
    reader.onload = function(){
      var img = document.getElementById("student_image_preview_nursery");
  ...
  var imageUpload = document.getElementById("student_image_upload_nursery");
  var imagePreview = document.getElementById("student_image_preview_nursery");
