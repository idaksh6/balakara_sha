...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-pink-500 text-white shadow-md rounded-lg p-6">
        ...
        <div class="bg-yellow-500 text-white shadow-md rounded-lg p-6">
            ...
            <p class="text-gray-100 text-4xl font-bold text-center"><span class="mr-2"></i></span>{{ $category->count }}
            </p>
            @endif
            @endforeach
        </div>
        <div class="bg-gray-500 text-white shadow-md rounded-lg p-6">
