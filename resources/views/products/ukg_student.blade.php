...
<form action="{{ isset($product) ? route('products.update', $product->id) : route('products.saveukg') }}" method="post"
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <input type="file" name="student_image" accept="image/*" onchange="showFile_ukg(event)">
                    </div>
    ...
    function showFile_ukg(event) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function() {
          const preview = document.getElementById('student_image_preview_ukg');
